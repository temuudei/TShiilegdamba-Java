...
public class View {
    ...
    public Forager makeForager() {
        ...
        forager.setFirstName(io.readRequiredString("Enter your first name: "));
        forager.setLastName(io.readRequiredString("Enter your last name: "));
        forager.setState(io.readRequiredString("Enter your state: "));
        return forager;
    }
